...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -q -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://github.com/XrayR-project/XrayR/releases/download/v0.8.7/XrayR-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        url="https://github.com/XrayR-project/XrayR/releases/download/v0.8.7/XrayR-linux-${arch}.zip"
